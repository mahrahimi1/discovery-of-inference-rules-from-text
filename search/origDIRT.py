'''
Reads several tsv files which are the results of preprocessing 
the corpus by preprocess.scala. Then for a given path, finds the
top k similar paths according to the original DIRT method. More 
specifically:
    ...
    4- outputs the top k candidate paths in descending order of their 
...
def main():
    ...
    # read an input path from stdin
    input_path_string = input("Enter a path: ")
    p = None
